(custom-set-variables
 ...
 '(custom-enabled-themes (quote (planet-theme)))
 '(custom-safe-themes
   (quote
    ("a56a6bf2ecb2ce4fa79ba636d0a5cf81ad9320a988ec4e55441a16d66b0c10e0" "c74e83f8aa4c78a121b52146eadb792c9facc5b1f02c917e3dbb454fca931223" default)))
 ...
 '(package-selected-packages
   (quote
    (js2-highlight-vars yaml-mode which-key use-package tide smex smart-mode-line-powerline-theme sass-mode rjsx-mode rainbow-mode project-explorer planet-theme markdown-mode highlight-symbol helm-git-grep helm flycheck-title editorconfig diff-hl counsel company-tern coffee-mode atom-one-dark-theme anzu)))
...
(custom-set-faces
 ...
 '(fringe ((t (:background "#1D262E"))))
 '(helm-source-header ((t (:height 150))))
 '(hl-line ((t (:background "#3E4450"))))
 '(js2-highlight-vars-face ((t (:inherit secondary-selection))))
 ...
 '(minibuffer-prompt ((t (:background "#3E4450" :foreground "#FFFFFF" :family "Menlo"))))
